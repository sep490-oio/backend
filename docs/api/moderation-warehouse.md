...
- Muc dich: Lay Get All Settings qua GET /api/admin/settings.
- Audience: admin
- Auth: Bearer token + permission App.Permissions.Catalogs.Admin.ReadSettings
- Headers: Authorization: Bearer <token>
- Path params: none
- Query params: none
- Request body: none
- Success responses:
  - 200 OK: [IReadOnlyList<SystemSettingDto>](./schemas.md#schema-ireadonlylist-systemsettingdto)
- Error statuses: none documented

### GET /api/admin/settings/{key}

- Muc dich: Lay Get Setting By Key qua GET /api/admin/settings/{key}.
- Audience: admin
- Auth: Bearer token + permission App.Permissions.Catalogs.Admin.ReadSettings
- Headers: Authorization: Bearer <token>
- Path params:
...
- Request body: none
- Success responses:
  - 200 OK: [SystemSettingDto](./schemas.md#schema-systemsettingdto)
- Error statuses: none documented

### PUT /api/admin/settings/{key}

- Muc dich: Cap nhat Update System Setting qua PUT /api/admin/settings/{key}.
- Audience: admin
- Auth: Bearer token + permission App.Permissions.Catalogs.Admin.ManageSettings
- Headers: Authorization: Bearer <token>
- Path params:
  - key: string
- Query params: none
- Request body: [UpdateSystemSettingEndpoint.Request](./schemas.md#schema-updatesystemsettingendpoint-request)
- Success responses:
  - 204 No Content: none
- Error statuses: none documented
