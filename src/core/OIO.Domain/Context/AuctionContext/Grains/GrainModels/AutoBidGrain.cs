...
public struct AutoBidGrain
{
    ...
    public static AutoBidGrain From(AutoBid autoBid)
    {
        return new AutoBidGrain
        {
            ...
            MaxAmount = MoneyGrain.From(autoBid.MaxAmount),
            CurrentAmount = MoneyGrain.From(autoBid.CurrentAmount),
            IsEnabled = autoBid.IsEnabled,
            IncrementAmount = autoBid.IncrementAmount != null ? MoneyGrain.From(autoBid.IncrementAmount) : null,
