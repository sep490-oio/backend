...
{
    /// <inheritdoc />
    public partial class config_payment_method_index : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                name: "uq_payment_methods_user_vnpay_active",
                table: "payment_methods",
                columns: new[] { "user_id", "bank_code", "masked_card_number" },
                unique: true,
                filter: "is_active = true AND type = 'vnpay' AND masked_card_number IS NOT NULL");
            ...
            migrationBuilder.CreateIndex(
                name: "uq_payment_methods_user_card_active",
                table: "payment_methods",
                columns: new[] { "user_id", "type", "provider", "last_four", "expiry_month", "expiry_year" },
                unique: true,
                filter: "is_active = true AND type IN ('credit_card','debit_card')");

            migrationBuilder.CreateIndex(
                name: "uq_payment_methods_user_e-wallet_active",
                table: "payment_methods",
                columns: new[] { "user_id", "type", "provider", "holder_name" },
                unique: true,
                filter: "is_active = true AND type = 'e_wallet'");

            migrationBuilder.CreateIndex(
                name: "uq_payment_methods_user_bank_active",
                table: "payment_methods",
                columns: new[] { "user_id", "type", "provider", "masked_card_number", "last_four" },
                unique: true,
