...
{
    /// <inheritdoc />
    public partial class WarehouseInspectionDecisionLog : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "warehouse_inspection_decision_logs",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_warehouse_inspection_decision_logs", x => x.id);
                    table.ForeignKey(
                        name: "fk_warehouse_inspection_decision_logs_warehouse_inspections_in",
                        column: x => x.inspection_id,
                        principalTable: "warehouse_inspections",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateIndex(
                name: "idx_warehouse_inspection_decision_logs_inspection_id",
                table: "warehouse_inspection_decision_logs",
