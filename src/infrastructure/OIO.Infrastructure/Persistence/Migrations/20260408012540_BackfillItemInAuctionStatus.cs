...
{
    /// <inheritdoc />
    public partial class BackfillItemInAuctionStatus : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            // ============================================================================
            // Data backfill: items linked to a Scheduled/Active auction must be in_auction.
            // Historical bug: when an Auction transitioned to Scheduled/Active the linked
            // Item.Status was not synced. Repair existing rows here. Idempotent and safe to
            // re-run because of the WHERE clauses on both items and auctions status.
            // ============================================================================
        ...
        {
            // Data-fix migration: Down is a no-op. The schema reverts below restore
            // the index annotations only.
            migrationBuilder.DropIndex(
                name: "idx_auctions_priority",
                table: "auctions");
