...
namespace OIO.Infrastructure.Persistence.Migrations
{
    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "auction_view_records",
                columns: table => new
                {
                    id = table.Column<Guid>(type: "uuid", nullable: false),
                    auction_id = table.Column<Guid>(type: "uuid", nullable: false),
                    user_id = table.Column<Guid>(type: "uuid", nullable: true),
                    browser_viewer_id = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_auction_view_records", x => x.id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    raw_content = table.Column<string>(type: "jsonb", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_gateway_webhook_events", x => x.id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    shipment_mode = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    relocation_attempt_count = table.Column<int>(type: "integer", nullable: false, defaultValue: 0),
                    next_relocation_attempt_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    last_relocation_error = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    decision_window_ends_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    disputed_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    completed_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    cancelled_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    ship_by_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    is_shipping_overdue = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    escalated_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    escalation_reason = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    ...
                    shipping_street = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    resolved_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    escalated_emergency_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    requires_platform_inspection = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    seller_received_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    disputed_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    completed_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    qr_token_version = table.Column<int>(type: "integer", nullable: false, defaultValue: 1),
                    qr_token_issued_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    qr_token_revoked_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    seller_declared_shipped_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    buyer_package_condition = table.Column<string>(type: "character varying(32)", maxLength: 32, nullable: true),
                    buyer_condition_notes = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: true),
                    manual_review_required = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    manual_review_reason = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true),
                    status = table.Column<string>(type: "character varying(30)", maxLength: 30, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    currency = table.Column<string>(type: "character varying(3)", maxLength: 3, nullable: false, defaultValue: "VND"),
                    description = table.Column<string>(type: "text", nullable: true),
                    client_return_path = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    processed_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    created_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP"),
                    amount = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    amount_currency = table.Column<string>(type: "character varying(3)", maxLength: 3, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    created_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP"),
                    modified_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    case_domain = table.Column<string>(type: "text", nullable: true),
                    case_type = table.Column<string>(type: "text", nullable: true),
                    primary_target_type = table.Column<string>(type: "text", nullable: true),
                    case_order_id = table.Column<Guid>(type: "uuid", nullable: true),
                    case_auction_id = table.Column<Guid>(type: "uuid", nullable: true),
                    shipment_id = table.Column<Guid>(type: "uuid", nullable: true),
                    warehouse_item_id = table.Column<Guid>(type: "uuid", nullable: true),
                    payment_id = table.Column<Guid>(type: "uuid", nullable: true),
                    resolution_outcome = table.Column<string>(type: "text", nullable: true),
                    resolution_reason = table.Column<string>(type: "text", nullable: true),
                    resolution_action_set_json = table.Column<string>(type: "text", nullable: true),
                    resolved_by = table.Column<Guid>(type: "uuid", nullable: true),
                    case_resolved_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    assigned_to_user_id = table.Column<Guid>(type: "uuid", nullable: true),
                    assigned_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    context_snapshot_json = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_disputes_identity_verification_verification_id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<Guid>(type: "uuid", nullable: false),
                    item_id = table.Column<Guid>(type: "uuid", nullable: false),
                    auction_type = table.Column<string>(type: "text", nullable: true),
                    ...
                    assigned_admin_id = table.Column<Guid>(type: "uuid", nullable: true),
                    assigned_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    verify_by_platform = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    rejection_count = table.Column<int>(type: "integer", nullable: false, defaultValue: 0),
                    ...
                    created_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP"),
                    modified_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    auto_extend = table.Column<bool>(type: "boolean", nullable: true),
                    end_time = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    extension_count = table.Column<int>(type: "integer", nullable: true),
                    extension_minutes = table.Column<int>(type: "integer", nullable: true),
                    ...
                    priority_reason = table.Column<string>(type: "jsonb", nullable: true),
            ...
            migrationBuilder.CreateTable(
                name: "seller_direct_shipment_evidence",
                columns: table => new
                {
                    id = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_seller_direct_shipment_evidence", x => x.id);
                    table.ForeignKey(
                        name: "fk_seller_direct_shipment_evidence_seller_direct_shipments_shi",
                        column: x => x.shipment_id,
                        principalTable: "seller_direct_shipments",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    verdict_recommendation = table.Column<string>(type: "text", nullable: true),
                    summary = table.Column<string>(type: "text", nullable: false),
                    finding_note = table.Column<string>(type: "text", nullable: true),
                    created_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP")
                },
                constraints: table =>
                {
                    table.PrimaryKey("pk_dispute_findings", x => x.id);
                    table.ForeignKey(
                        name: "fk_dispute_findings_disputes_dispute_id",
                        column: x => x.dispute_id,
                        principalTable: "disputes",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    visibility = table.Column<string>(type: "text", nullable: false, defaultValue: "external"),
                    created_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                name: "dispute_participant_states",
                columns: table => new
                {
                    id = table.Column<Guid>(type: "uuid", nullable: false),
                    dispute_id = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_dispute_participant_states", x => x.id);
                    table.ForeignKey(
                        name: "fk_dispute_participant_states_disputes_dispute_id",
                        column: x => x.dispute_id,
                        principalTable: "disputes",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    order_id = table.Column<Guid>(type: "uuid", nullable: false),
                    warehouse_item_id = table.Column<Guid>(type: "uuid", nullable: true),
                    shipment_mode = table.Column<string>(type: "character varying(30)", maxLength: 30, nullable: false),
                    external_carrier_name = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    provider_code = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                    client_order_code = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    carrier_tracking_number = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    ...
                    buyer_received_package_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    buyer_accepted_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    buyer_acknowledged_source = table.Column<string>(type: "character varying(30)", maxLength: 30, nullable: true),
                    created_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP"),
                    modified_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    qr_payload = table.Column<string>(type: "text", nullable: true),
                    qr_code_url = table.Column<string>(type: "text", nullable: true),
                    qr_token_version = table.Column<int>(type: "integer", nullable: false, defaultValue: 0),
                    qr_token_issued_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    qr_token_revoked_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    height_cm = table.Column<int>(type: "integer", nullable: true),
                    length_cm = table.Column<int>(type: "integer", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    inbound_shipment_id = table.Column<Guid>(type: "uuid", nullable: false),
                    item_id = table.Column<Guid>(type: "uuid", nullable: false),
                    declared_condition = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                    ...
                    reviewed_by = table.Column<Guid>(type: "uuid", nullable: true),
                    reviewed_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    seller_confirmed_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    created_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP"),
                    modified_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("pk_warehouse_inspections", x => x.id);
                    table.ForeignKey(
                        name: "fk_warehouse_inspections_inbound_shipments_inbound_shipment_id",
                        column: x => x.inbound_shipment_id,
                        principalTable: "inbound_shipments",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "fk_warehouse_inspections_warehouse_item_warehouse_item_id",
                        column: x => x.warehouse_item_id,
                        principalTable: "warehouse_items",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_warehouse_item_media", x => x.id);
                    table.ForeignKey(
                        name: "fk_warehouse_item_media_warehouse_item_warehouse_item_id",
                        column: x => x.warehouse_item_id,
                        principalTable: "warehouse_items",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    created_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP"),
                    modified_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    held_amount = table.Column<decimal>(type: "numeric", nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "auction_buy_now_reservations",
                columns: table => new
                {
                    id = table.Column<Guid>(type: "uuid", nullable: false),
                    auction_id = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_auction_buy_now_reservations", x => x.id);
                    table.ForeignKey(
                        name: "fk_auction_buy_now_reservations_auction_auction_id",
                        column: x => x.auction_id,
                        principalTable: "auctions",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<Guid>(type: "uuid", nullable: false),
                    auction_id = table.Column<Guid>(type: "uuid", nullable: false),
                    new_auction_id = table.Column<Guid>(type: "uuid", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    offer_status = table.Column<string>(type: "text", nullable: false, defaultValue: "pending")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                name: "dispute_finding_references",
                columns: table => new
                {
                    id = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_dispute_finding_references", x => x.id);
                    table.ForeignKey(
                        name: "fk_dispute_finding_references_dispute_findings_finding_id",
                        column: x => x.finding_id,
                        principalTable: "dispute_findings",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateTable(
                name: "dispute_message_attachments",
                columns: table => new
                {
                    id = table.Column<Guid>(type: "uuid", nullable: false),
                    dispute_id = table.Column<Guid>(type: "uuid", nullable: false),
                    dispute_message_id = table.Column<Guid>(type: "uuid", nullable: false),
                    media_upload_id = table.Column<Guid>(type: "uuid", nullable: false),
                    sort_order = table.Column<int>(type: "integer", nullable: false, defaultValue: 0),
                    created_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP"),
                    modified_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_dispute_message_attachments", x => x.id);
                    table.ForeignKey(
                        name: "fk_dispute_message_attachments_dispute_message_dispute_message",
                        column: x => x.dispute_message_id,
                        principalTable: "dispute_messages",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "fk_dispute_message_attachments_disputes_dispute_id",
                        column: x => x.dispute_id,
                        principalTable: "disputes",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "outbound_shipment_evidence",
                columns: table => new
                {
                    id = table.Column<Guid>(type: "uuid", nullable: false),
                    shipment_id = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_outbound_shipment_evidence", x => x.id);
                    table.ForeignKey(
                        name: "fk_outbound_shipment_evidence_outbound_shipments_shipment_id",
                        column: x => x.shipment_id,
            ...
            migrationBuilder.CreateIndex(
                name: "idx_auction_buy_now_reservations_auction_id",
                table: "auction_buy_now_reservations",
                column: "auction_id");

            migrationBuilder.CreateIndex(
                name: "idx_auction_buy_now_reservations_buyer_id",
                table: "auction_buy_now_reservations",
                column: "buyer_id");

            migrationBuilder.CreateIndex(
                name: "idx_auction_buy_now_reservations_expires_at",
                table: "auction_buy_now_reservations",
                column: "expires_at");

            migrationBuilder.CreateIndex(
                name: "idx_auction_buy_now_reservations_payment_transaction_id",
                table: "auction_buy_now_reservations",
            ...
            migrationBuilder.CreateIndex(
                name: "idx_auction_relist_history_new_auction_id",
                table: "auction_relist_history",
                column: "new_auction_id");

            migrationBuilder.CreateIndex(
                name: "IX_auction_view_records_auction_browser",
                table: "auction_view_records",
                columns: new[] { "auction_id", "browser_viewer_id" },
                unique: true,
                filter: "browser_viewer_id IS NOT NULL");

            migrationBuilder.CreateIndex(
                name: "IX_auction_view_records_auction_ip",
                table: "auction_view_records",
                columns: new[] { "auction_id", "ip_hash" },
                filter: "ip_hash IS NOT NULL AND browser_viewer_id IS NULL AND user_id IS NULL");

            migrationBuilder.CreateIndex(
                name: "IX_auction_view_records_auction_user",
                table: "auction_view_records",
                columns: new[] { "auction_id", "user_id" },
                unique: true,
            ...
            migrationBuilder.CreateIndex(
                name: "idx_auctions_assigned_admin_id",
                table: "auctions",
            ...
            migrationBuilder.CreateIndex(
                name: "idx_bids_auction_bidder_created_at",
                table: "bids",
                columns: new[] { "auction_id", "bidder_id", "created_at" });
            ...
            migrationBuilder.CreateIndex(
                name: "idx_bids_auction_ip_created_at",
                table: "bids",
                columns: new[] { "auction_id", "ip_address", "created_at" });
            ...
            migrationBuilder.CreateIndex(
                name: "idx_dispute_finding_references_finding_id",
                table: "dispute_finding_references",
                column: "finding_id");

            migrationBuilder.CreateIndex(
                name: "idx_dispute_findings_dispute_id",
                table: "dispute_findings",
                column: "dispute_id");

            migrationBuilder.CreateIndex(
                name: "idx_dispute_message_attachments_message_id",
                table: "dispute_message_attachments",
                column: "dispute_message_id");

            migrationBuilder.CreateIndex(
                name: "idx_unique_dispute_message_attachments_media_upload_id",
                table: "dispute_message_attachments",
                column: "media_upload_id",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "ix_dispute_message_attachments_dispute_id",
                table: "dispute_message_attachments",
                column: "dispute_id");

            migrationBuilder.CreateIndex(
                name: "idx_dispute_messages_dispute_created_at",
                table: "dispute_messages",
                columns: new[] { "dispute_id", "created_at", "id" });

            migrationBuilder.CreateIndex(
                name: "idx_dispute_participant_states_user",
                table: "dispute_participant_states",
                column: "user_id");

            migrationBuilder.CreateIndex(
                name: "idx_unique_dispute_participant_states_dispute_user",
                table: "dispute_participant_states",
                columns: new[] { "dispute_id", "user_id" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "idx_disputes_verification_id",
                table: "disputes",
            ...
            migrationBuilder.CreateIndex(
                name: "idx_inbound_shipments_shipment_mode",
                table: "inbound_shipments",
            ...
            migrationBuilder.CreateIndex(
                name: "idx_media_uploads_next_relocation_attempt",
                table: "media_uploads",
                column: "next_relocation_attempt_at");
            ...
            migrationBuilder.CreateIndex(
                name: "idx_monitoring_alerts_entity_type_created_at",
                table: "monitoring_alerts",
                columns: new[] { "entity_type", "entity_id", "alert_type", "created_at" });
            ...
            migrationBuilder.CreateIndex(
                name: "idx_order_returns_tracking_number",
                table: "order_returns",
            ...
            migrationBuilder.CreateIndex(
                name: "idx_orders_overdue_scan",
                table: "orders",
                column: "ship_by_at",
                filter: "is_shipping_overdue = false AND ship_by_at IS NOT NULL");
            ...
            migrationBuilder.CreateIndex(
                name: "idx_outbound_shipment_evidence_shipment_category",
                table: "outbound_shipment_evidence",
                columns: new[] { "shipment_id", "category" });

            migrationBuilder.CreateIndex(
                name: "idx_outbound_shipment_evidence_shipment_id",
                table: "outbound_shipment_evidence",
                column: "shipment_id");
            ...
            migrationBuilder.CreateIndex(
                name: "idx_reports_dispute_id",
                table: "reports",
                column: "dispute_id",
                filter: "dispute_id IS NOT NULL");
            ...
            migrationBuilder.CreateIndex(
                name: "ix_seller_direct_shipment_evidence_shipment_id_kind",
                table: "seller_direct_shipment_evidence",
                columns: new[] { "shipment_id", "kind" });
            ...
            migrationBuilder.CreateIndex(
                name: "ix_user_sessions_device_created_at",
                table: "user_sessions",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_user_sessions_ip_created_at",
                table: "user_sessions",
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "warehouse_inspections",
                column: "inbound_shipment_id",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "idx_unique_warehouse_inspections_warehouse_item_id",
                table: "warehouse_inspections",
                column: "warehouse_item_id",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "idx_warehouse_inspections_decision_status",
                table: "warehouse_inspections",
                column: "decision_status");

            migrationBuilder.CreateIndex(
                name: "idx_warehouse_inspections_item_id",
                table: "warehouse_inspections",
                column: "item_id");

            migrationBuilder.CreateIndex(
                name: "idx_warehouse_item_media_warehouse_item_id",
                table: "warehouse_item_media",
                column: "warehouse_item_id");
            ...
            migrationBuilder.CreateIndex(
                name: "idx_gateway_webhooks_processing",
                table: "gateway_webhook_events",
                columns: new[] { "provider", "processing_status" });
