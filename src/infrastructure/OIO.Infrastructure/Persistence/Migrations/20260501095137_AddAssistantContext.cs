...
{
    /// <inheritdoc />
    public partial class AddAssistantContext : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    role_context = table.Column<string>(type: "character varying(32)", maxLength: 32, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "idx_assistant_conversations_user_last_message",
                table: "assistant_conversations",
                columns: new[] { "user_id", "last_message_at" },
                descending: new[] { false, true });

            migrationBuilder.CreateIndex(
                name: "idx_assistant_messages_conversation_created",
