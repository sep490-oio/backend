...
namespace OIO.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260501095137_AddAssistantContext")]
    partial class AddAssistantContext
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OIO.Domain.Context.AssistantContext.Aggregates.AssistantConversation", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("OIO.Domain.Context.AssistantContext.Aggregates.AssistantMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("OIO.Domain.Context.AuctionContext.Aggregates.Auctions.AuctionBuyNowReservation", b =>
                {
                    ...
                    b.Property<decimal>("BuyNowAmount")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)")
                        .HasColumnName("buy_now_price");
                    ...
                    b.Property<decimal>("DepositAppliedAmountValue")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)")
                    ...
                    b.Property<decimal>("GatewayAmountDueValue")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)")
            ...
            modelBuilder.Entity("OIO.Domain.Context.AuctionContext.Aggregates.Auctions.AuctionViewRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.Property<string>("BrowserViewerId")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_auction_view_records");

                    b.HasIndex("AuctionId", "BrowserViewerId")
                        .IsUnique()
                        .HasDatabaseName("IX_auction_view_records_auction_browser")
                        .HasFilter("browser_viewer_id IS NOT NULL");

                    b.HasIndex("AuctionId", "IpHash")
                    ...
                    b.ToTable("auction_view_records", (string)null);
                });
            ...
            modelBuilder.Entity("OIO.Domain.Context.AuctionContext.Aggregates.Auctions.Bid", b =>
                {
                    ...
                    b.HasIndex("AuctionId", "BidderId", "CreatedAt")
                        .HasDatabaseName("idx_bids_auction_bidder_created_at");

                    b.HasIndex("AuctionId", "IpAddress", "CreatedAt")
            ...
            modelBuilder.Entity("OIO.Domain.Context.CatalogContext.Aggregates.Items.Item", b =>
                {
                    ...
                    b.Property<bool>("RequiresPlatformInspection")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
            ...
            modelBuilder.Entity("OIO.Domain.Context.ModerationContext.Aggregates.Disputes.Dispute", b =>
                {
                    ...
                    b.Property<Guid?>("CaseAuctionId")
                        .HasColumnType("uuid")
                        .HasColumnName("case_auction_id");

                    b.Property<string>("CaseDomain")
                        .HasColumnType("text")
                        .HasColumnName("case_domain");

                    b.Property<Guid?>("CaseOrderId")
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("ResolutionActionSetJson")
                        .HasColumnType("text")
            ...
            modelBuilder.Entity("OIO.Domain.Context.ModerationContext.Aggregates.Disputes.DisputeFinding", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.Property<string>("VerdictRecommendation")
                        .HasColumnType("text")
                        .HasColumnName("verdict_recommendation");

                    b.HasKey("Id")
                        .HasName("pk_dispute_findings");

                    b.HasIndex("DisputeId")
                        .HasDatabaseName("idx_dispute_findings_dispute_id");

                    b.ToTable("dispute_findings", (string)null);
                });

            modelBuilder.Entity("OIO.Domain.Context.ModerationContext.Aggregates.Disputes.DisputeFindingReference", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_dispute_finding_references");

                    b.HasIndex("FindingId")
                        .HasDatabaseName("idx_dispute_finding_references_finding_id");

                    b.ToTable("dispute_finding_references", (string)null);
                });
            ...
            modelBuilder.Entity("OIO.Domain.Context.ModerationContext.Aggregates.MonitoringAlert", b =>
                {
                    ...
                    b.HasIndex("EntityType", "EntityId", "AlertType", "CreatedAt")
            ...
            modelBuilder.Entity("OIO.Domain.Context.OrderContext.Aggregates.Orders.Order", b =>
                {
                    ...
                    b.Property<bool>("IsPlatformVerifiedItem")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
                        .HasColumnName("is_platform_verified_item");

                    b.Property<bool>("IsShippingOverdue")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
            ...
            modelBuilder.Entity("OIO.Domain.Context.OrderContext.Aggregates.Orders.OrderReturn", b =>
                {
                    ...
                    b.Property<decimal?>("DeferredRefundAmount")
                        .HasColumnType("numeric(18,2)")
                        .HasColumnName("deferred_refund_amount");

                    b.Property<string>("DeferredRefundIntent")
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)")
                    ...
                    b.Property<string>("ShippingFeePayer")
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)")
            ...
            modelBuilder.Entity("OIO.Domain.Context.OrderContext.Aggregates.Orders.OrderReturnEvidence", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_order_return_evidence");

                    b.HasIndex("OrderReturnId")
                        .HasDatabaseName("idx_order_return_evidence_order_return_id");

                    b.HasIndex("OrderReturnId", "Category")
                        .HasDatabaseName("idx_order_return_evidence_return_category");

                    b.ToTable("order_return_evidence", (string)null);
                });

            modelBuilder.Entity("OIO.Domain.Context.OrderContext.Aggregates.SellerDirectShipments.SellerDirectShipment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.Property<string>("BuyerConditionNotes")
                        .HasMaxLength(2000)
                        .HasColumnType("character varying(2000)")
                        .HasColumnName("buyer_condition_notes");

                    b.Property<string>("BuyerPackageCondition")
                        .HasMaxLength(32)
                        .HasColumnType("character varying(32)")
                        .HasColumnName("buyer_package_condition");

                    b.Property<DateTime?>("BuyerReceivedPackageAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("buyer_received_package_at");

                    b.Property<DateTime?>("CarrierBookedAt")
                        .HasColumnType("timestamp with time zone")
                    ...
                    b.Property<string>("InternalTrackingCode")
                        .IsRequired()
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)")
                    ...
                    b.Property<DateTime?>("OnDeliveringAt")
                        .HasColumnType("timestamp with time zone")
                    ...
                    b.Property<DateTime?>("QrTokenIssuedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("qr_token_issued_at");

                    b.Property<DateTime?>("QrTokenRevokedAt")
                        .HasColumnType("timestamp with time zone")
                    ...
                    b.Property<DateTime?>("SellerDeclaredShippedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("seller_declared_shipped_at");

                    b.Property<string>("ShipmentIdDisplay")
                        .IsRequired()
                        .HasMaxLength(30)
                        .HasColumnType("character varying(30)")
                        .HasColumnName("shipment_id_display");

                    b.ComplexProperty(typeof(Dictionary<string, object>), "Status", "OIO.Domain.Context.OrderContext.Aggregates.SellerDirectShipments.SellerDirectShipment.Status#SellerDirectShipmentStatus", b1 =>
                        {
                            b1.IsRequired();
                    ...
                    b.HasKey("Id")
                        .HasName("pk_seller_direct_shipments");

                    b.HasIndex("InternalTrackingCode")
                        .IsUnique()
                    ...
                    b.HasIndex("ShipmentIdDisplay")
                        .IsUnique()
                        .HasDatabaseName("uq_seller_direct_shipments_shipment_id_display");

                    b.ToTable("seller_direct_shipments", (string)null);
                });

            modelBuilder.Entity("OIO.Domain.Context.OrderContext.Aggregates.SellerDirectShipments.SellerDirectShipmentEvidence", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_seller_direct_shipment_evidence");

                    b.HasIndex("ShipmentId", "Kind")
                        .HasDatabaseName("ix_seller_direct_shipment_evidence_shipment_id_kind");

                    b.ToTable("seller_direct_shipment_evidence", (string)null);
                });
            ...
            modelBuilder.Entity("OIO.Domain.Context.PaymentContext.Aggregates.Transactions.Transaction", b =>
                {
                    ...
                    b.HasIndex("BuyNowReservationId")
            ...
            modelBuilder.Entity("OIO.Domain.Context.PaymentContext.Aggregates.Wallets.Wallet", b =>
                {
                    ...
                    b.ComplexProperty(typeof(Dictionary<string, object>), "WalletFunds", "OIO.Domain.Context.PaymentContext.Aggregates.Wallets.Wallet.WalletFunds#WalletFunds", b1 =>
                        {
                            b1.IsRequired();
            ...
            modelBuilder.Entity("OIO.Domain.Context.UserContext.Aggregates.Users.RecoveryCode", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("OIO.Domain.Context.UserContext.Aggregates.Users.VerificationDocument", b =>
                {
                    ...
                    b.ComplexProperty(typeof(Dictionary<string, object>), "DocumentType", "OIO.Domain.Context.UserContext.Aggregates.Users.VerificationDocument.DocumentType#VerificationDocumentType", b1 =>
                        {
                            b1.IsRequired();
            ...
            modelBuilder.Entity("OIO.Domain.Context.WarehouseContext.Aggregates.OutboundShipments.OutboundShipment", b =>
                {
                    ...
                    b.Property<string>("BuyerAcknowledgedSource")
                        .HasMaxLength(30)
                        .HasColumnType("character varying(30)")
            ...
            modelBuilder.Entity("OIO.Domain.Context.WarehouseContext.Aggregates.OutboundShipments.OutboundShipmentEvidence", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("OIO.Domain.Context.WarehouseContext.Aggregates.WarehouseItems.WarehouseInspectionDecisionLog", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_warehouse_inspection_decision_logs");

                    b.HasIndex("InspectionId")
                        .HasDatabaseName("idx_warehouse_inspection_decision_logs_inspection_id");

                    b.ToTable("warehouse_inspection_decision_logs", (string)null);
                });
            ...
            modelBuilder.Entity("OIO.Domain.Context.WarehouseContext.Aggregates.WarehouseItems.WarehouseItemMedia", b =>
                {
                    ...
                    b.ComplexProperty(typeof(Dictionary<string, object>), "Info", "OIO.Domain.Context.WarehouseContext.Aggregates.WarehouseItems.WarehouseItemMedia.Info#MediaInfo", b1 =>
                        {
                            b1.IsRequired();
                    ...
                    b.ComplexProperty(typeof(Dictionary<string, object>), "StorageRef", "OIO.Domain.Context.WarehouseContext.Aggregates.WarehouseItems.WarehouseItemMedia.StorageRef#StorageRef", b1 =>
                        {
                            b1.IsRequired();
                    ...
                    b.HasKey("Id")
                        .HasName("pk_warehouse_item_media");

                    b.HasIndex("WarehouseItemId")
                        .HasDatabaseName("idx_warehouse_item_media_warehouse_item_id");

                    b.ToTable("warehouse_item_media", (string)null);
                });
            ...
            modelBuilder.Entity("OIO.Domain.Context.WarehouseContext.Aggregates.WarehouseToSellerShipments.WarehouseToSellerShipment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.Property<Guid>("WarehouseInspectionId")
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_warehouse_to_seller_shipments");

                    b.HasIndex("WarehouseInspectionId")
                        .IsUnique()
                    ...
                    b.ToTable("warehouse_to_seller_shipments", (string)null);
                });

            modelBuilder.Entity("OIO.Domain.Context.WarehouseContext.Aggregates.WarehouseToSellerShipments.WarehouseToSellerShipmentEvidence", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_warehouse_to_seller_shipment_evidence");
                    ...
                    b.ToTable("warehouse_to_seller_shipment_evidence", (string)null);
                });
            ...
            modelBuilder.Entity("OIO.Infrastructure.Outbox.OutboxMessage", b =>
                {
                    ...
                    b.HasIndex("OccurredAt")
                        ...
                        .HasFilter("processed_at IS NULL AND attempt_count < 3");
            ...
            modelBuilder.Entity("OIO.Domain.Context.AssistantContext.Aggregates.AssistantMessage", b =>
                {
                    b.HasOne("OIO.Domain.Context.AssistantContext.Aggregates.AssistantConversation", "Conversation")
                        .WithMany("Messages")
            ...
            modelBuilder.Entity("OIO.Domain.Context.ModerationContext.Aggregates.Disputes.DisputeFinding", b =>
                {
                    b.HasOne("OIO.Domain.Context.ModerationContext.Aggregates.Disputes.Dispute", "Dispute")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_dispute_findings_disputes_dispute_id");
            ...
            modelBuilder.Entity("OIO.Domain.Context.ModerationContext.Aggregates.Disputes.DisputeFindingReference", b =>
                {
                    b.HasOne("OIO.Domain.Context.ModerationContext.Aggregates.Disputes.DisputeFinding", null)
                        .WithMany("References")
                        .HasForeignKey("FindingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_dispute_finding_references_dispute_findings_finding_id");
                });
            ...
            modelBuilder.Entity("OIO.Domain.Context.OrderContext.Aggregates.Orders.OrderReturnEvidence", b =>
                {
                    b.HasOne("OIO.Domain.Context.OrderContext.Aggregates.Orders.OrderReturn", null)
                        .WithMany("Evidence")
                        .HasForeignKey("OrderReturnId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_order_return_evidence_order_return_order_return_id");
                });
            ...
            modelBuilder.Entity("OIO.Domain.Context.OrderContext.Aggregates.SellerDirectShipments.SellerDirectShipment", b =>
                {
                    b.HasOne("OIO.Domain.Context.OrderContext.Aggregates.Orders.Order", null)
                        .WithOne()
                        .HasForeignKey("OIO.Domain.Context.OrderContext.Aggregates.SellerDirectShipments.SellerDirectShipment", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_seller_direct_shipments_orders_order_id");
                });

            modelBuilder.Entity("OIO.Domain.Context.OrderContext.Aggregates.SellerDirectShipments.SellerDirectShipmentEvidence", b =>
                {
                    b.HasOne("OIO.Domain.Context.OrderContext.Aggregates.SellerDirectShipments.SellerDirectShipment", null)
                        .WithMany("Evidence")
                        .HasForeignKey("ShipmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_seller_direct_shipment_evidence_seller_direct_shipments_shi");
                });
            ...
            modelBuilder.Entity("OIO.Domain.Context.WarehouseContext.Aggregates.OutboundShipments.OutboundShipmentEvidence", b =>
                {
                    b.HasOne("OIO.Domain.Context.WarehouseContext.Aggregates.OutboundShipments.OutboundShipment", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_outbound_shipment_evidence_outbound_shipments_shipment_id");
                });
            ...
            modelBuilder.Entity("OIO.Domain.Context.WarehouseContext.Aggregates.WarehouseItems.WarehouseInspectionDecisionLog", b =>
                {
                    b.HasOne("OIO.Domain.Context.WarehouseContext.Aggregates.WarehouseItems.WarehouseInspection", null)
                        .WithMany("DecisionLogs")
                        .HasForeignKey("InspectionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_warehouse_inspection_decision_logs_warehouse_inspections_in");
                });
            ...
            modelBuilder.Entity("OIO.Domain.Context.WarehouseContext.Aggregates.WarehouseItems.WarehouseItemMedia", b =>
                {
                    b.HasOne("OIO.Domain.Context.WarehouseContext.Aggregates.WarehouseItems.WarehouseItem", "WarehouseItem")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_warehouse_item_media_warehouse_item_warehouse_item_id");
            ...
            modelBuilder.Entity("OIO.Domain.Context.WarehouseContext.Aggregates.WarehouseToSellerShipments.WarehouseToSellerShipmentEvidence", b =>
                {
                    b.HasOne("OIO.Domain.Context.WarehouseContext.Aggregates.WarehouseToSellerShipments.WarehouseToSellerShipment", null)
                        .WithMany("Evidence")
                        .HasForeignKey("ShipmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_warehouse_to_seller_shipment_evidence_warehouse_to_seller_s");
                });

            modelBuilder.Entity("OIO.Infrastructure.Outbox.OutboxMessageConsumer", b =>
                {
                    b.HasOne("OIO.Infrastructure.Outbox.OutboxMessage", null)
                        .WithMany()
                        .HasForeignKey("OutboxMessageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_outbox_message_consumers_outbox_message_outbox_message_id");
                });
